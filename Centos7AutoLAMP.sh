...
wget https://raw.githubusercontent.com/akkradet/lamp/master/LAMP74/phpMyAdmin.conf
cp phpMyAdmin.conf /etc/httpd/conf.d/

mv /etc/phpMyAdmin/config.inc.php /etc/phpMyAdmin/config.inc.php.backup
wget https://raw.githubusercontent.com/akkradet/lamp/master/LAMP74/config.inc.php
